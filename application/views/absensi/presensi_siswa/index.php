    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                ...
                <div class="row">
                    <div class="col-sm-2">
                      <select class="form-control select2" id="pilih-kelas" onchange="get_siswa(this.value)">
                    ...
                    <div class="col-sm-3">
                      <select class="form-control select2" id="pilih-siswa"></select>
                    </div>
                    <div class="col-sm-3">
...
<script>
    ...
    function export_excel() {
        ...
        let pilih_siswa = $(`#pilih-siswa`).val()
        let date_start = $(`#date-start`).val()
        let date_end = $(`#date-end`).val()
        window.open(`<?= base_url('absensi/presensi_siswa/export_excel?pilih_kelas=') ?>${pilih_kelas}&pilih_siswa=${pilih_siswa}&date_start=${date_start}&date_end=${date_end}`, '_blank').focus();
    }
    ...
    function get_data() {
        ...
        $.ajax({
            url: '<?= base_url('absensi/presensi_siswa/get_data') ?>',
            method: 'GET',
            data: {pilih_kelas, pilih_siswa, date_start, date_end},
            dataType: 'json',
