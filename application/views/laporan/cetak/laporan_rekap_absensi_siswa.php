...
<html>
  ...
  <body class="body">
  <h2 style="text-align:center;">Rekapan Absensi Siswa Kelas <?php echo $kelas['tingkatan_kelas'] . ' ' .$kelas['nama_kelas']; ?></h2>
  ...
  <table>
    <tbody>
      ...
      <tr>
        ...
        <td style="width: 2%;">:</td>
        <td><?php echo $kelas['tingkatan_kelas'] . ' ' .$kelas['nama_kelas']; ?></td>
      </tr>
      <tr>
      ...
      <tr>
        <td style="width: 15%;">Status Absen</td>
        <td style="width: 2%;">:</td>
        <td><?php echo $status_absensi; ?></td>
      </tr>
    </tbody>
  </table>
  <br>
